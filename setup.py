...
# internal data via __plugin_name__ in the
# plugin module
...
# data via __plugin_description__ in the plugin
# module
...
plugin_author = "Mike Ratcliffe"

# The plugin's author's mail address.
plugin_author_email = "michael@ratcliffefamily.org"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal
# data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/MikeRatcliffe/OctoPrint-FullScreen"
...
# "templates", "static" and "translations" will
...
# default setup parameters as provided by octoprint_setuptools.
# Create_plugin_setup_parameters using octoprint.util.dict_merge.
#
# Example:
