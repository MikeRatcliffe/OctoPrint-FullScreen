...
class FullscreenPlugin(
    ...
    def get_settings_defaults(self):
        return dict(
            ...
            button_color_fg="rgba(51, 51, 51, 1)",
            button_color_bg_top="rgba(255, 255, 255, 1)",
            button_color_bg_bottom="rgba(230, 230, 230, 1)",
    ...
    def get_template_vars(self):
        return dict(
            ...
            button_color_fg=self._settings.get(["button_color_fg"]),
            button_color_bg_top=self._settings.get(["button_color_bg_top"]),
            button_color_bg_bottom=self._settings.get(["button_color_bg_bottom"]),
