...
(function (e, t) {
  typeof exports == `object` && typeof module < `u`
    ...
    : typeof define == `function` && define.amd
      ? define([], t)
      : ((e = typeof globalThis < `u` ? globalThis : e || self), (e.ofsPickr = t()));
})(this, function () {
  ...
  function n(e, t, n, r, i = {}) {
    (t instanceof HTMLCollection || t instanceof NodeList
      ...
      : Array.isArray(t) || (t = [t]),
      Array.isArray(n) || (n = [n]));
    for (let a of t) for (let t of n) a[e](t, r, { capture: !1, ...i });
    return Array.prototype.slice.call(arguments, 1);
  }
  var r = n.bind(null, `addEventListener`),
    i = n.bind(null, `removeEventListener`);
  function a(e) {
    ...
    return e instanceof Element
      ...
      : typeof e == `string`
        ? e
            .split(/>>/g)
            .reduce(
              (e, t, n, r) => ((e = e.querySelector(t)), n < r.length - 1 ? e.shadowRoot : e),
              document,
            )
        : null;
  }
  function l(e, t = e => e) {
    function n(n) {
      let r = [0.001, 0.01, 0.1][Number(n.shiftKey || n.ctrlKey * 2)] * (n.deltaY < 0 ? 1 : -1),
        i = 0,
        a = e.selectionStart;
      ((e.value = e.value.replace(/[\d.]+/g, (e, n) =>
        n <= a && n + e.length >= a ? ((a = n), t(Number(e), r, i)) : (i++, e),
      )),
        e.focus(),
    ...
    (r(e, `focus`, () => r(window, `wheel`, n, { passive: !1 })),
      r(e, `blur`, () => i(window, `wheel`, n)));
  }
  ...
  function _(e, t, n) {
    let r = h(e, t, n),
      ...
      l = s === 1 ? 0 : (1 - a - s) / (1 - s),
      d = s === 1 ? 0 : (1 - o - s) / (1 - s);
    return [c * 100, l * 100, d * 100, s * 100];
  }
  function v(e, t, n) {
    ((t /= 100), (n /= 100));
    let r = ((2 - t) * n) / 2;
    return (
      r !== 0 && (t = r === 1 ? 0 : r < 0.5 ? (t * n) / (r * 2) : (t * n) / (2 - r * 2)),
      [e, t * 100, r * 100]
    );
  }
  function y(e, t, n) {
    ...
    if (a === 0) o = s = 0;
      ...
      let r = ((i - e) / 6 + a / 2) / a,
        c = ((i - t) / 6 + a / 2) / a,
        l = ((i - n) / 6 + a / 2) / a;
      (e === i ? (o = l - c) : t === i ? (o = 1 / 3 + r - l) : n === i && (o = 2 / 3 + c - r),
        o < 0 ? (o += 1) : o > 1 && --o);
    }
  ...
  function x(e, t, n) {
    ((t /= 100), (n /= 100), (t *= n < 0.5 ? n : 1 - n));
    let r = ((2 * t) / (n + t)) * 100,
      i = (n + t) * 100;
    return [e, isNaN(r) ? 0 : r, i];
  }
  function S(e) {
  ...
  function C(e) {
    ...
    let t = {
      ...
      n = e => e.map(e => (/^(|\d+)\.\d+|\d+$/.test(e) ? Number(e) : void 0)),
      r;
    invalid: for (let i in t)
      if ((r = t[i].exec(e)))
        switch (i) {
          case `cmyk`: {
            let [, e, t, a, o] = n(r);
            if (e > 100 || t > 100 || a > 100 || o > 100) break invalid;
            return { values: b(e, t, a, o), type: i };
          }
          case `rgba`: {
            let [, e, , t, , a, , , o] = n(r);
            if (
              ...
              (a = r[6] === `%` ? (a / 100) * 255 : a),
              (o = r[9] === `%` ? o / 100 : o),
              e > 255 || t > 255 || a > 255 || o < 0 || o > 1)
            )
              break invalid;
            return { values: [...y(e, t, a), o], a: o, type: i };
          }
          case `hexa`: {
            let [, e] = r;
            (e.length === 4 || e.length === 3) &&
              (e = e
                .split(``)
                .map(e => e + e)
                .join(``));
            let t = e.substring(0, 6),
              n = e.substring(6);
            return (
              (n = n ? parseInt(n, 16) / 255 : void 0),
              { values: [...S(t), n], a: n, type: i }
            );
          }
          case `hsla`: {
            let [, e, t, a, , o] = n(r);
            if (((o = r[6] === `%` ? o / 100 : o), e > 360 || t > 100 || a > 100 || o < 0 || o > 1))
              break invalid;
            return { values: [...x(e, t, a), o], a: o, type: i };
          }
          case `hsva`: {
            let [, e, t, a, , o] = n(r);
            if (((o = r[6] === `%` ? o / 100 : o), e > 360 || t > 100 || a > 100 || o < 0 || o > 1))
              break invalid;
            return { values: [e, t, a, o], a: o, type: i };
          }
        }
  ...
  function w(e = 0, t = 0, n = 0, r = 1) {
    let i =
        (e, t) =>
        (n = -1) =>
          t(~n ? e.map(e => Number(e.toFixed(n))) : e),
      a = {
        h: e,
        s: t,
        v: n,
  ...
  function E(e) {
    let t = {
            ...
            if (r === `keydown` && (a || o || s || c)) {
              ...
              (n === `v`
                ...
                : n === `h`
                  ? (r = a || o ? -1 : 1)
                  : ((i = a ? -1 : +!!s), (r = c ? -1 : +!!o)),
                t.update(T(t.cache.x + 0.01 * r), T(t.cache.y + 0.01 * i)),
                e.preventDefault());
        ...
        _tapmove(e) {
          let { options: n, cache: r } = t,
            { lock: i, element: a, wrapper: o } = n,
          ...
          if (e) {
            ...
            ((c = e ? (t || e).clientX : 0),
              (l = e ? (t || e).clientY : 0),
              c < s.left ? (c = s.left) : c > s.left + s.width && (c = s.left + s.width),
              l < s.top ? (l = s.top) : l > s.top + s.height && (l = s.top + s.height),
              (c -= s.left),
              (l -= s.top));
          } else r && ((c = r.x * s.width), (l = r.y * s.height));
          (i !== `h` && (a.style.left = `calc(${(c / s.width) * 100}% - ${a.offsetWidth / 2}px)`),
            i !== `v` && (a.style.top = `calc(${(l / s.height) * 100}% - ${a.offsetHeight / 2}px)`),
            (t.cache = { x: c / s.width, y: l / s.height }));
          let u = T(c / s.width),
            d = T(l / s.height);
          switch (i) {
            case `v`:
        ...
        update(e = 0, n = 0) {
          ...
          (t.options.lock === `h` && (n = e),
            t._tapmove({ clientX: r + a * e, clientY: i + o * n }));
        },
        destroy() {
          let { options: e, _tapstart: n, _keyboard: r } = t;
          (i(document, [`keydown`, `keyup`], r),
            i([e.wrapper, e.element], `mousedown`, n),
            i([e.wrapper, e.element], `touchstart`, n, { passive: !1 }));
        },
      },
      { options: n, _tapstart: a, _keyboard: o } = t;
    return (
      r([n.wrapper, n.element], `mousedown`, a),
      r([n.wrapper, n.element], `touchstart`, a, { passive: !1 }),
      r(document, [`keydown`, `keyup`], o),
      t
    );
  }
  function D(e = {}) {
    ...
    let t = r(e.elements, `click`, t => {
      (e.elements.forEach(n => n.classList[t.target === n ? `add` : `remove`](e.className)),
        e.onchange(t),
        t.stopPropagation());
    });
    return { destroy: () => i(...t) };
  ...
  var O = e => {
      let {
        ...
        c = e => (e ? `` : `style="display:none" hidden`),
        l = t => e._t(t),
        u = o(`
    ...
    `),
        d = u.interaction;
      return (
        d.options.find(e => !e.hidden && !e.classList.add(`active`)),
        (d.type = () => d.options.find(e => e.classList.contains(`active`))),
        u
      );
    },
    k = {
    ...
    A = (e, t, n) => {
      let {
          ...
          variantFlipOrder: c,
          positionFlipOrder: l,
        } = { container: document.documentElement.getBoundingClientRect(), ...k, ...n },
        { left: u, top: d } = t.style;
      ((t.style.left = `0`), (t.style.top = `0`));
      let f = e.getBoundingClientRect(),
        p = t.getBoundingClientRect(),
        m = { t: f.top - p.height - a, b: f.bottom + a, r: f.right + a, l: f.left - p.width - a },
        h = {
          vs: f.left,
        ...
        v = l[g],
        y = c[_],
        { top: b, left: x, bottom: S, right: C } = r;
      for (let e of v) {
        let n = e === `t` || e === `b`,
          r = m[e],
          [a, s] = n ? [`top`, `left`] : [`left`, `top`],
          [c, l] = n ? [p.height, p.width] : [p.width, p.height],
          [u, d] = n ? [S, C] : [C, S],
          [g, _] = n ? [b, x] : [x, b];
        if (!(r < g || r + c + o > u))
          for (let u of y) {
            ...
            if (!(m < _ || m + l + o > d)) {
              if (((m -= p[s]), (r -= p[a]), (t.style[s] = `${m}px`), (t.style[a] = `${r}px`), i)) {
                let t = n ? f.width / 2 : f.height / 2,
                  o = l / 2,
                  d = t > o,
                  p = { s: d ? o : t, m: o, e: d ? o : l - t },
                  h = { t: c, b: 0, r: 0, l: c },
                  g = m + p[u],
                  _ = r + h[e];
    ...
    j = (e, t, n) => {
      let r =
        typeof e == `object` && !(e instanceof HTMLElement) ? e : { reference: e, popper: t, ...n };
      return {
        update(e = r) {
  ...
  return class e {
    ...
    constructor(t) {
      ...
      ((r.opacity = !o && l),
        ...
        this._bindEvents(),
        this._finalBuild(),
        n && n.length && n.forEach(e => this.addSwatch(e)));
      let { button: f, app: p } = this._root;
      ((this._nanopop = j(f, p, { margin: s })),
        f.setAttribute(`role`, `button`),
        f.setAttribute(`aria-label`, this._t(`btn:toggle`)));
      let m = this;
      this._setupAnimationFrame = requestAnimationFrame(function e() {
        if (!p.offsetWidth) return requestAnimationFrame(e);
        (m.setColor(t.default),
          m._rePositioningPicker(),
          t.defaultRepresentation &&
            ((m._representation = t.defaultRepresentation),
            m.setColorRepresentation(m._representation)),
          t.showAlways && m.show(),
          (m._initializingActive = !1),
          m._emit(`init`));
      });
    }
    ...
    _buildComponents() {
      let e = this,
        ...
        [r, i] = n.match(/^[vh]+$/g) ? n : [],
        a = () => (this._color ||= this._lastColor.clone()),
        o = {
          palette: E({
            ...
            onchange(n, r) {
              ...
              let i = a(),
                { _root: o, options: s } = e,
                { lastColor: c, currentColor: l } = o.preview;
              e._recalc &&
                ((i.s = n * 100),
                (i.v = 100 - r * 100),
                i.v < 0 && (i.v = 0),
              ...
              ((this.element.style.background = u),
                (this.wrapper.style.background = `
                    ...
                    `),
                s.comparison
                  ? !s.useAsButton && !e._lastColor && c.style.setProperty(`--pcr-color`, u)
                  : (o.button.style.setProperty(`--pcr-color`, u),
                    o.button.classList.remove(`clear`)));
              let d = i.toHEXA().toString();
              for (let { el: t, color: n } of e._swatchColors)
                t.classList[d === n.toHEXA().toString() ? `add` : `remove`](`pcr-active`);
          ...
          hue: E({
            ...
            onchange(n) {
              ...
              let r = a();
              (e._recalc && (r.h = n * 360),
                (this.element.style.backgroundColor = `hsl(${r.h}, 100%, 50%)`),
                o.palette.trigger());
            },
          }),
          opacity: E({
            ...
            onchange(n) {
              ...
              let r = a();
              (e._recalc && (r.a = Math.round(n * 100) / 100),
                (this.element.style.background = `rgba(0, 0, 0, ${r.a})`),
                o.palette.trigger());
            },
          }),
          selectable: D({
    ...
    _bindEvents() {
      ...
      if (!t.showAlways) {
        ...
        n.push(
          r(e.button, `click`, () => (this.isOpen() ? this.hide() : this.show())),
          r(document, `keyup`, e => this.isOpen() && (e.key === i || e.code === i) && this.hide()),
          r(
            document,
    ...
    _updateOutput(e) {
      ...
      if (t.interaction.type()) {
        ...
        t.interaction.result.value =
          typeof n[e] == `function` ? n[e]().toString(r.outputPrecision) : ``;
      }
      !this._initializingActive && this._recalc && this._emit(`change`, n, e, this);
    }
    _clearColor(e = !1) {
      let { _root: t, options: n } = this;
      (n.useAsButton || t.button.style.setProperty(`--pcr-color`, `rgba(0, 0, 0, 0.15)`),
    ...
    _parseLocalColor(e) {
      let { values: t, type: n, a: r } = C(e),
        { lockOpacity: i } = this.options,
        a = r !== void 0 && r !== 1;
      return (
        t && t.length === 3 && (t[3] = void 0),
        { values: !t || (i && a) ? null : t, type: n }
      );
    }
    _t(t) {
    ...
    addSwatch(e) {
      ...
      if (t) {
        let { _swatchColors: e, _root: n } = this,
          i = w(...t),
          o = a(
            `<button type="button" style="--pcr-color: ${i.toRGBA().toString(0)}" aria-label="${this._t(`btn:swatch`)}"/>`,
          );
        return (
          n.swatches.appendChild(o),
          e.push({ el: o, color: i }),
          this._eventBindings.push(
            r(o, `click`, () => {
              (this.setHSVA(...i.toHSVA(), !0),
    ...
    applyColor(e = !1) {
      let { preview: t, button: n } = this._root,
        r = this._color.toRGBA().toString(0);
      return (
        t.lastColor.style.setProperty(`--pcr-color`, r),
        this.options.useAsButton || n.style.setProperty(`--pcr-color`, r),
    ...
    destroy() {
      (cancelAnimationFrame(this._setupAnimationFrame),
        this._eventBindings.forEach(e => i(...e)),
    ...
    setHSVA(e = 360, t = 0, n = 0, r = 1, i = !1) {
      ...
      if (
        ((this._recalc = !1),
        e < 0 || e > 360 || t < 0 || t > 100 || n < 0 || n > 100 || r < 0 || r > 1)
      )
        return !1;
